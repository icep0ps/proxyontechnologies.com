...
import { useRef, useEffect, forwardRef, useMemo, CSSProperties } from 'react';
...
float pattern(vec2 p, float time, float speed, float freq, float amp) {
  vec2 p2 = p - time * speed;
  return fbm(p + fbm(p2, freq, amp), freq, amp); 
}
